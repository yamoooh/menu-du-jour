...
export const translations = {
  fr: {
    ...
    restaurantNav: {
      dashboard: 'Tableau de bord',
      restaurants: 'Mon restaurant',
      menus: 'Mes menus du jour',
      reservations: 'Réservations',
      notifications: 'Notifications',
    ...
    restaurant: {
      title: 'Espace Gestionnaire Restaurant',
      badge: 'Accès Professionnel',
      welcome: 'Bonjour',
      activeRestaurant: 'Établissement actif :',
      createRestaurantCta: 'Créer un établissement',
      editRestaurantCta: 'Modifier la fiche',
      hoursTitle: 'Horaires d\'ouverture',
      noHoursSet: 'Aucun horaire renseigné.',
      noRestaurants: 'Vous n\'avez pas encore créé de restaurant.',
      noRestaurantsDesc: 'Créez la fiche de votre établissement dès maintenant pour bénéficier immédiatement de 7 jours d\'essai gratuit.',
      profileTitle: 'Profil du gestionnaire',
      managerRole: 'Gestionnaire de restaurant',
    },
  },
  en: {
    meta: {
    ...
    restaurant: {
      ...
      welcome: 'Hello',
      activeRestaurant: 'Active Establishment:',
      createRestaurantCta: 'Create Establishment',
      editRestaurantCta: 'Edit Details',
      hoursTitle: 'Opening Hours',
      noHoursSet: 'No opening hours set.',
      noRestaurants: 'You have not created any restaurants yet.',
      noRestaurantsDesc: 'Create your restaurant profile now to start your 7-day free trial immediately.',
      profileTitle: 'Manager Profile',
      managerRole: 'Restaurant Manager',
    },
  },
}
